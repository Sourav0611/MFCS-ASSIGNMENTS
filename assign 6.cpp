/* QUESTION 6 ) GIVEN QUESTION CONVERT IN PDNF  */
...
int main()
{
    ...
    cout<<"\n  -> Expression MUST HAVE no space and only two variable can be in a parenthesis() only"<<endl;
    cout<<"\n whole condition is in parenthesis() only"<<endl;
