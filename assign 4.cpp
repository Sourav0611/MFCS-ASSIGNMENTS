/* QUESTION 4 ) EVALUTAE POSTFIX EXPRESSION (USING STACK) */
...
int main()
{
   ;
    string postfix ;
    cout<<"enter postfix expression as integers without space and with +,^,-,/,* operands "<<endl;
    //like input 59+33^4*6/-
    cin>>postfix;
    cout<<"The answer after evaluating the postfix expression is : ";
